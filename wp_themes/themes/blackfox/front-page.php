...
<section>
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="banner-content">
                ...
                <p><?php the_field('descriptions'); ?></p><a class="button" href="#scroll-calendar">Записаться на игру</a>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <h5><?php the_field('descriptions_title'); ?></h5>
              <div class="about-content">
                ...
                <div class="description">
                  <p><?php the_field('descriptions_about'); ?></p>
                </div>
              </div>
            </div>
          </div>
                        ...
                        if ( $loop->have_posts() ) : while ( $loop->have_posts() ) : $loop->the_post(); ?>
                            <div class="item">
                                <div class="img"><img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="#">
                                    ...
                                    <h3><?php the_title(); ?></h3>
                                        ...
                                        <ul>
                                            <?php foreach($games as $game) { ?>
                                                <?php if($game == 'DEMO') { ?>
                                                    <li class="demo"><?php echo $field['DEMO'][ $game ]; ?>DEMO</li>
                                                <?php } elseif ($game == 'NEW') { ?>
                                                    <li class="new"><?php echo $field['NEW'][ $game ]; ?>NEW</li>
                                    ...
                                    <i class="icon-<?php the_field('isons_person'); ?>"><?php the_field('number_persons'); ?></i>
                                    <?php the_content(); ?>
                                ...
                                echo mb_strimwidth($content, 0, 50, '...'); ?></p>
                            </div>
                            <?php endwhile;
                        endif;
                        wp_reset_postdata();
      ...
      <div class="our-advantages">
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <h2><?php the_field('title_advantages'); ?></h2>
              <h5><?php the_field('descriptions_advantages'); ?></h5>
              <div class="items">
                <?php if( have_rows('advantages') ): while ( have_rows('advantages') ) : the_row(); ?>
                    <div class="item"><i class="icon-<?php the_sub_field('icon_advantages'); ?>"></i>
                        <p><?php the_sub_field('name_advantages'); ?></p>
                    </div>
                <?php endwhile; endif; ?>
              </div>
            </div>
              ...
              <div class="calendar-block">
                ...
                <div class="right-block">
                  <form id="scroll-form" action="" method="POST" class="vrbooking">
                    ...
                    <h3 class="price">Цена <span> <?php echo $price_array[0]; ?></span><strong> грн</strong></h3>
                    <div class="button">
      ...
      <div class="banner-min" style="background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/img_clients/banner-bg-2.jpg)">
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <h2><?php the_field('title_banner'); ?></h2><a class="button" href="#scroll-calendar">Отправить заявку</a>
            </div>
          </div>
        </div>
      </div>
      <div class="gallery" id="scroll-gallery">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <h2><?php the_field('title_gallery'); ?></h2>
              <h5><?php the_field('description_gallery'); ?></h5>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <h5><?php the_field('descriptions_reviews'); ?></h5>
              <div class="slider-reviews">
                <?php if( have_rows('reviews') ): while( have_rows('reviews') ): the_row(); 
                    ...
                    <div class="item">
                        ...
                        <?php } ?>
                        <div class="description">
                            <h3><?php echo $full_name; ?><span><?php echo $position; ?></span></h3>
                            <p><?php echo $reviews_full; ?></p>
                        </div>
                    </div>
                <?php endwhile; endif; ?>
